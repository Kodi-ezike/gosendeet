    ...
    <div className="md:px-20 px-6 py-8 bg-neutral100">
      ...
      <div className="grid xl:grid-cols-4 grid-cols-2 md:gap-6 gap-6 mb-4">
        ...
        <div>
          ...
          <p
            className={cn(
              statusClasses[bookingData?.status] ?? "bg-gray-100 text-gray-800", // fallback if status not found
      ...
      <div className="overflow-x-auto">
        <div className="min-w-[600px] w-full relative mb-4">
          ...
          <div className="flex justify-between text-left px-3 xl:px-4 py-4 w-full bg-white">
            ...
            <div className="flex-1 text-sm">
              <div className="mb-8">
                <p className="font-medium mb-2">{bookingData?.senderName}</p>
            ...
            <div className="flex-1 text-sm">
              <div className="mb-8">
                <p className="font-medium mb-2">{bookingData?.receiverName}</p>
                <p className="text-neutral600 pr-6 mb-2">
                  {bookingData?.destination}
                </p>
                <p className="text-neutral600">{bookingData?.receiverPhone}</p>
              </div>
            </div>
          </div>
        </div>
