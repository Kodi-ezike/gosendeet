...
const Testimonials = () => {
  ...
  return (
    <div className="v2-testimonials-section py-20 md:px-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="font-clash text-5xl lg:text-6xl font-black text-[#1a1f3a] mb-4">
            WHAT OUR <span className="v2-gradient-accent">CUSTOMERS SAY</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              key={index}
              className="bg-white rounded-3xl p-8 shadow-2xl border-4 border-[#1a1f3a] hover:shadow-3xl transition-all duration-300 group hover:-translate-y-2"
            ...
            >
              ...
              <div className="flex items-center gap-4 pt-6 border-t-2 border-gray-200">
                <img
                  ...
                  className="w-14 h-14 rounded-full border-4 border-[#1a1f3a] group-hover:scale-110 transition-transform duration-300"
                />
                <div>
                  <div className="font-clash font-bold text-[#1a1f3a] text-lg">
                    {testimonial.name}
                  </div>
        ...
        >
          <button className="px-12 py-5 rounded-full bg-[#1a1f3a] hover:bg-black text-white font-black text-lg shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:shadow-3xl border-4 border-[#1a1f3a] hover:border-black">
