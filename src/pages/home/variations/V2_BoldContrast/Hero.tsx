...
const Hero = () => {
  return (
    <div className="v2-hero min-h-screen flex flex-col justify-center md:px-20 px-6 py-12 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        ...
        {/* Trust Indicators - Bold Checkboxes in Row */}
        <motion.div
        ...
        {/* Stats Grid - Bold & Colorful with Yellow/Gold accent */}
        <motion.div
        ...
        >
          {[
            ...
            { number: "10K+", label: "Shipments", gradient: "from-blue-500 to-cyan-500" },
            { number: "4.9★", label: "Rating", gradient: "from-orange-500 to-amber-500" },
            { number: "24/7", label: "Support", gradient: "from-yellow-500 to-orange-500" },
          ].map((stat, index) => (
            <div
              key={index}
