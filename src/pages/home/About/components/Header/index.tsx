const Header = () => {
  return (
    <>
      <div className="h-[90vh] bg-about bg-cover md:px-20 px-6 py-20">
        <div className="h-full flex flex-col justify-end items-end">
          <div className="flex lg:flex-row flex-col lg:justify-between gap-8 items-center">
            ...
            <p className="lg:w-[55%] leading-[140%] lg:text-left text-center">
      ...
      <div className="lg:px-40 md:px-20 px-6 py-20 bg-purple300">
